...
Your working directory is the `workspace/` folder inside ~/.morphy/. This is your full-stack workspace:
...
- NEVER look in `dist/` or `dist-chat/` — those are stale build artifacts.
