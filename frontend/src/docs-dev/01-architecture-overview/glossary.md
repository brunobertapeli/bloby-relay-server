...
| **Relay**        | Optional cloud service (`api.bloby.bot`) that maps stable domains to ephemeral tunnel URLs.                                  |
...
| **dist-bloby/**  | Pre-built chat SPA served as static files. Survives all other crashes.                                                       |
