...
4. If you changed `supervisor/chat/` source, run `npm run build:chat` and include the updated `dist-chat/` in your commit
...
- [ ] If chat UI was modified, `dist-chat/` is rebuilt and included
