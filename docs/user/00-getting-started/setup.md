...
This is the one-time setup that gets Morphy running. Here's what happens step by step.

## 1. Tunnel mode

You'll be asked how you want to access Morphy remotely. Use the arrow keys to pick one:
...
After you pick a tunnel mode, Morphy runs through these steps automatically:
...
7. Installs the daemon (macOS/Linux) so Morphy starts automatically
...
4. Once DNS propagates, your domain points to Morphy
